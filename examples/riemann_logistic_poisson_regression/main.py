...
n_samples = 100
M = 100
projection_dim = 100 # log: 100#random projection dimension for Hilbert csts
pihat_noise = .0 # log: 0.75 #noise level (relative) for corrupting pihat
opt_itrs = 500
###############################
...
tsf_realistic = bc.BayesianTangentSpaceFactory(lambda th : log_likelihood_2d2d(Z, th), lambda sz, wts, idcs : np.random.multivariate_normal(mu, cov, sz), projection_dim)
...
iht = bc.IHTCoreset(tsf_realistic, projection_dim)
