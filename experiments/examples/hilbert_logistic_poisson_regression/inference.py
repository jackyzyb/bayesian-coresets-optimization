...
def hmc(logp, gradlogp, x0, sample_steps=1000, adapt=True, adapt_steps=100, burn_steps=100, step_size=0.25,
        n_leapfrogs=10, target_accept=0.65, gamma=0.05, k=0.75, t0=10., scale=None, progress_bar=True, seed=None):
...
def nuts(logp, gradlogp, x0, sample_steps=1000, adapt=True, adapt_steps=100, burn_steps=100, step_size=0.25,
         n_leapfrogs=None, Emax=1000, target_accept=0.65, gamma=0.05, k=0.75, t0=10., scale=None, progress_bar=True,
         seed=None):
    step_size = step_size / x0.shape[0] ** (1 / 4.)
    if scale is None:
        scale = np.ones(x0.shape[0])
